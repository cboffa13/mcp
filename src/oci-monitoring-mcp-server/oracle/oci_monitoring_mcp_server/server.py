...
@mcp.tool(
    ...
    "Only use this tool if you already know the MQL query."
    "If you do not know the query, you MUST use the MQL Syntax Guide resource.",
)
async def get_metrics_data(
    context: Context,
    compartment_id: str = CompartmentField,
    query: str = Field(
        description="The Monitoring Query Language (MQL) expression to use when searching for metric data points to aggregate. "
        ...
        examples=[
            ...
            'CpuUtilization[5m]{resourceId = "ocid1.loadbalancer.oc1.phx.aaaaaaaaojv7kj6yv4nvrw4i3vtafbovfb5r5wf3cnoxyjhcu33sxpkp4ybq"}.max()',
        ],
    ),
    ...
    resolution: Optional[str] = Field(
        ...
        "The resolution must 'be equal or less than the interval in the query. The default resolution is 1m (one minute).",
    ...
    try:
        ...
        summarize_metrics_data_details = SummarizeMetricsDataDetails(
            namespace="oci_lbaas",
            query='BytesReceived[1m]{resourceId = "ocid1.loadbalancer.oc1.phx.aaaaaaaaojv7kj6yv4nvrw4i3vtafbovfb5r5wf3cnoxyjhcu33sxpkp4ybq"}.mean()',
            start_time="2025-12-18T18:25:00.000Z",
            end_time="2025-12-18T19:25:00.000Z",
            resource_group=resource_group,
